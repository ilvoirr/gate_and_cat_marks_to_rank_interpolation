...
// ── CAT 2025 Sectional Data ───────────────────────────────────────────────────
const CAT_VARC_DATA = [
  { m: 0, p: 0.00 }, { m: 2, p: 13.64 }, { m: 4, p: 25.89 }, { m: 6, p: 36.73 },
  { m: 8, p: 46.14 }, { m: 10, p: 54.07 }, { m: 12, p: 60.49 }, { m: 14, p: 66.24 },
  { m: 16, p: 71.44 }, { m: 18, p: 76.92 }, { m: 20, p: 80.90 }, { m: 22, p: 84.50 },
  { m: 24, p: 87.48 }, { m: 26, p: 89.81 }, { m: 28, p: 91.61 }, { m: 30, p: 93.38 },
  { m: 32, p: 94.76 }, { m: 34, p: 95.91 }, { m: 36, p: 96.78 }, { m: 38, p: 97.66 },
  { m: 40, p: 98.20 }, { m: 42, p: 98.75 }, { m: 44, p: 99.07 }, { m: 46, p: 99.41 },
  { m: 48, p: 99.58 }, { m: 50, p: 99.74 }, { m: 52, p: 99.87 }, { m: 54, p: 99.94 },
  { m: 56, p: 99.96 }, { m: 58, p: 99.98 }, { m: 60, p: 99.99 }, { m: 62, p: 100.00 },
  { m: 64, p: 100.00 }, { m: 66, p: 100.00 }, { m: 68, p: 100.00 }, { m: 70, p: 100.00 },
  { m: 72, p: 100.00 }
];

const CAT_DILR_DATA = [
  { m: 0, p: 0.00 }, { m: 2, p: 27.38 }, { m: 4, p: 47.07 }, { m: 6, p: 59.06 },
  { m: 8, p: 68.79 }, { m: 10, p: 75.17 }, { m: 12, p: 81.02 }, { m: 14, p: 85.05 },
  { m: 16, p: 88.64 }, { m: 18, p: 92.07 }, { m: 20, p: 94.25 }, { m: 22, p: 96.04 },
  { m: 24, p: 96.80 }, { m: 26, p: 98.02 }, { m: 28, p: 98.50 }, { m: 30, p: 99.09 },
  { m: 32, p: 99.34 }, { m: 34, p: 99.58 }, { m: 36, p: 99.71 }, { m: 38, p: 99.82 },
  { m: 40, p: 99.88 }, { m: 42, p: 99.91 }, { m: 44, p: 99.94 }, { m: 46, p: 99.97 },
  { m: 48, p: 99.98 }, { m: 50, p: 99.98 }, { m: 52, p: 99.99 }, { m: 54, p: 99.99 },
  { m: 56, p: 99.99 }, { m: 58, p: 100.00 }, { m: 60, p: 100.00 }, { m: 62, p: 100.00 },
  { m: 64, p: 100.00 }, { m: 66, p: 100.00 }
];

const CAT_QA_DATA = [
  { m: 0, p: 0.00 }, { m: 2, p: 34.37 }, { m: 4, p: 50.06 }, { m: 6, p: 62.53 },
  { m: 8, p: 73.38 }, { m: 10, p: 79.63 }, { m: 12, p: 84.91 }, { m: 14, p: 89.60 },
  { m: 16, p: 92.55 }, { m: 18, p: 94.56 }, { m: 20, p: 96.29 }, { m: 22, p: 97.66 },
  { m: 24, p: 98.37 }, { m: 26, p: 98.60 }, { m: 28, p: 99.17 }, { m: 30, p: 99.44 },
  { m: 32, p: 99.60 }, { m: 34, p: 99.73 }, { m: 36, p: 99.82 }, { m: 38, p: 99.88 },
  { m: 40, p: 99.93 }, { m: 42, p: 99.95 }, { m: 44, p: 99.96 }, { m: 46, p: 99.97 },
  { m: 48, p: 99.98 }, { m: 50, p: 99.98 }, { m: 52, p: 99.99 }, { m: 54, p: 99.99 },
  { m: 56, p: 99.99 }, { m: 58, p: 100.00 }, { m: 60, p: 100.00 }, { m: 62, p: 100.00 },
  { m: 64, p: 100.00 }, { m: 66, p: 100.00 }
];
